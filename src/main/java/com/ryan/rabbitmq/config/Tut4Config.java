...
import com.ryan.rabbitmq.service.receiver.Tut4Receiver;
import com.ryan.rabbitmq.service.sender.Tut4Sender;
...
public class Tut4Config {
    ...
    public TopicExchange topic() {
        return new TopicExchange("ewsn.lwm2m.observation");
    }

    @Bean
    public TopicExchange topic2() {
        return new TopicExchange("ewsn.lwm2m.command.response");
    }
